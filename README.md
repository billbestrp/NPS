...
bash
# Download NPS01.py or NPS02.py to your desired directory
...
- Configurability: All behavior controlled through environment variables
...
Authentication
Uses HTTP Basic Authentication with your API username and password.
